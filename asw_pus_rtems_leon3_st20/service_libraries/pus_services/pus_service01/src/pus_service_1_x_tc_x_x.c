...
error_code_t pus_service1_tx_TM_1_4_PID_stats_undefined(
		tc_handler_t *ptc_handler, uint16_t PID) {

	return (pus_service1_tx_TM_1_X_uint16_failure_data(ptc_handler,
			TCVerifStageExecStart, TM_1_4_TC_4_7_PID_STATS_UNDEFINED, PID));
}

error_code_t pus_service1_tx_TM_1_4_PID_read_only_via_TC(
		tc_handler_t *ptc_handler, uint16_t PID) {

	return (pus_service1_tx_TM_1_X_uint16_failure_data(ptc_handler,
			TCVerifStageExecStart, TM_1_4_TC_20_X_PID_READ_ONLY_VIA_TC, PID));
