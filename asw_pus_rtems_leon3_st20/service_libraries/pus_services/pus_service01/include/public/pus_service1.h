...
#define TM_1_4_TC_4_7_PID_STATS_UNDEFINED		6
#define TM_1_4_TC_5_X_INVALID_EV_ID				7
#define TM_1_4_TC_6_X_INVALID_MEMORY_ADDRESS	8
#define TM_1_4_TC_6_X_MEMORY_ID_READ_ONLY		9
#define TM_1_4_TC_6_X_OUT_OF_MEMORY_ID_LIMITS	10
#define TM_1_4_TC_11_X_SCHED_TC_REJECTED 		11
#define TM_1_4_TC_11_X_INVALID_SCHED_TIME		12
#define TM_1_4_TC_12_X_PMON_UNDEFINED			13
#define TM_1_4_TC_12_X_PMON_DEFINED				14
#define TM_1_4_TC_12_X_PMON_ENABLED				15
#define TM_1_4_TC_12_X_INVALID_PMONID			16
#define TM_1_4_TC_12_X_INVALID_PMON_DEFINITION	17
#define TM_1_4_TC_15_X_INVALID_PACKET_STORE		18
#define TM_1_4_TC_19_X_EV_ACTION_IS_ENABLED  	19
#define TM_1_4_TC_19_1_EV_ACTION_REJECTED 		20
#define TM_1_4_TC_19_X_EV_ACTION_NOT_DEFINED  	21
#define TM_1_4_TC_20_X_INVALID_PID 				22
#define TM_1_4_TC_20_X_PID_READ_ONLY_VIA_TC 	23
...
#define TM_1_8_TC_6_X_MEM_ACCESS_FAIL			4
#define TM_1_8_TC_11_X_SCHED_TC_POOL_EMPTY		5
#define TM_1_8_TC_19_1_MAX_EV_ACTIONS_REACHED 	6
...
/**
 * \brief TX a TM[1,4] The stats is not defined
 * \param ptc_handler pointer to the tc handler
 * \param PID whose stats does not exists
 * \return 0 if no error
 */
error_code_t pus_service1_tx_TM_1_4_PID_stats_undefined(tc_handler_t *ptc_handler,
		uint16_t PID);
 ...
 * \return 0 if no error
 */
error_code_t pus_service1_tx_TM_1_4_PID_read_only_via_TC(tc_handler_t *ptc_handler,
		uint16_t PID);
