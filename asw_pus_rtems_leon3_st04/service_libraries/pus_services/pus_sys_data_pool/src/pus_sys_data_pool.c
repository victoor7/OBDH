...
#define SYS_DATA_POOL_FIRST_UINT8_PARAM_ID (SYS_DATA_POOL_LAST_UINT32_PARAM_ID )
#define SYS_DATA_POOL_LAST_UINT8_PARAM_ID (SYS_DATA_POOL_LAST_UINT32_PARAM_ID + SYS_DATA_POOL_UINT8_PARAMS-1)

#define SYS_DATA_POOL_LAST_VALID_PARAM_ID SYS_DATA_POOL_LAST_UINT8_PARAM_ID
...
bool_t sys_data_pool_is_PID_update_via_TC_enabled(uint16_t param_id) {
	...
	//Param from 0 to 4 cannot be updated by TC
	return (param_id >= 5);
